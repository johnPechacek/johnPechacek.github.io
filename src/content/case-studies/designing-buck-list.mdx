...
<StatRow>
  <StatCard value="27%" context="vs 30% target" label="adoption" />
  <StatCard value="300,000+" context="vs 10,000 target" label="bucks identified" />
  <StatCard value="2.7 → 4+" label="images per buck" />
</StatRow>
