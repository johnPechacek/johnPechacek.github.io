...
heroImage: /images/bucklist-hero.webp
...
<ScreenGroup
  ...
  images={[
    {
      src: "/images/deer-survey-buck-count-1.webp",
      alt: "1st screen in Deer Survey mobile manual buck count flow",
    },
    {
      src: "/images/deer-survey-buck-count-2.webp",
      alt: "2nd screen in Deer Survey mobile manual buck count flow",
    },
    {
      src: "/images/deer-survey-buck-count-3.webp",
...
<figure>
  <img src="/images/lofiBP.webp" loading="lazy" alt="Early lo-fi wireframe of a buck profile screen, with placeholder fields for name, age, points, last seen, favorite spots, and notes above a grid of image placeholders" />
  <figcaption>The original lo-fi concept of a buck profile.</figcaption>
</figure>
...
<ScreenGroup
  caption="A Buck List profile: browse bucks from the gallery, open a profile to see last-seen time and location, then tag new images directly from the image detail view."
  images={[
    {
      src: "/images/BL-1.webp",
      alt: "Buck List tab in the Moultrie app gallery, showing a list of named buck profiles",
    },
    {
      src: "/images/BL-2.webp",
      alt: "A buck profile screen showing last-seen time and location above a grid of tagged images",
    },
    {
      src: "/images/BL-3.webp",
      alt: "Image detail view showing an image tagged to two buck profiles, Ghost and Titan",
    },
  ]}
/>
...
<figure>
  <img src="/images/BL-2.webp" loading="lazy" alt="A buck profile screen showing last-seen time and location above a grid of tagged images" />
  <figcaption>The finished profile screen: last-seen time and location lead, with the tagged image grid below.</figcaption>
</figure>
...
<ScreenGroup
  caption="The flyout sheet uses larger profile pictures than the gallery grid, making it easier to recognize the same buck across pictures taken in different contexts."
  images={[
    {
      src: "/images/flyout-1.webp",
      alt: "Flyout sheet of buck profile pictures open over an image detail view",
    },
    {
      src: "/images/flyout-2.webp",
      alt: "Flyout sheet showing a larger profile picture for comparison against the incoming image",
    },
    {
      src: "/images/flyout-3.webp",
      alt: "Flyout sheet dismissing after a buck profile is selected for tagging",
    },
  ]}
/>
...
<ScreenGroup
  caption="AI confirmation flow: a prompt on the buck profile surfaces new matches, then users toggle between the full profile photo and the current photo to confirm."
  images={[
    {
      src: "/images/ai-1.webp",
      alt: "Buck profile screen with a prompt saying new photos were found that match this buck, with options to review or dismiss",
    },
    {
      src: "/images/ai-2.webp",
      alt: "Confirm this match screen with the current photo selected in full, alongside a thumbnail of the profile photo",
    },
    {
      src: "/images/ai-3.webp",
      alt: "Confirm this match screen with the profile photo toggled to full size for comparison against the current photo",
    },
  ]}
/>
...
Without automatic cropping, the fallback was full trail camera images as profile thumbnails. That created two problems.
...
<figure>
  <img src="/images/crop-2.webp" loading="lazy" alt="Crop Buck Photo screen with a resizable frame over a trail camera image and a slider to adjust the crop area" />
  <figcaption>The manual crop step: a resizable frame over the trail camera image, with a slider to adjust crop size and a prompt to center the buck.</figcaption>
</figure>
...
Beyond the targets, the platform now holds a structured dataset of how individual animals move across a property, which cameras they appear on, and when they show up. That is the training data Phase 2 needs, generated by exactly the behavior the survey said hunters wanted.
