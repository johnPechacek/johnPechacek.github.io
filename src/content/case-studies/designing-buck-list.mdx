...
<figure>
  <img src="/images/lofiBP.png" alt="Early lo-fi wireframe of a buck profile screen, with placeholder fields for name, age, points, last seen, favorite spots, and notes above a grid of image placeholders" />
...
<figure>
  <img src="/images/BL-2.png" alt="A buck profile screen showing last-seen time and location above a grid of tagged images" />
...
<figure>
  <img src="/images/crop-2.png" alt="Crop Buck Photo screen with a resizable frame over a trail camera image and a slider to adjust the crop area" />
